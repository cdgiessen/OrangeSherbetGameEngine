...
void OnMouseButton(GLFWwindow* window, int glfwButton, int glfwAction) {
	...
	void OrangeSherbetGameEngine::setup_window() {
	...
	void OrangeSherbetGameEngine::TempRun() {
		...
		std::cout << "1 does it get this far?" << std::endl;
		...
		std::cout << "2 does it get this far?" << std::endl;
		...
		std::cout << "3 does it get this far?" << std::endl;
		...
		std::cout << "4 does it get this far?" << std::endl;
		...
		std::cout << "5 does it get this far?" << std::endl;

		setup_vao();

		std::cout << "6 does it get this far?" << std::endl;
